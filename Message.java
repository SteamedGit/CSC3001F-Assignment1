 ...
 */
    public Message(String receipientOfOriginalMessage, String senderOfOriginalMessage, String text){
       ...
       // Check messageCheck = new Check(reciever + senderOfOriginalMessage + text);
    ...
    public Message(String[] stringArray, String messageType, String senderOfOriginalMessage, String receipient)
    {
        if(messageType.equals(REQUEST_SEND_MESSAGE_CLIENT))
        {
            ...
            //System.out.println(receiptLine[0]);
     ...
     * 
     * ChatTP v1.0 //protocol and version
     * Send-MSG-C //request type
     * 29-03-2021 00:30:45 //timestamp
     * //hash goes here
     * //send & receive counts
     * Client 2 //recipient
     * Hello Client 2! //message text
     * 
     * 
     * @param socket 
     * @param packet
    ...
    public boolean testChecksum(String messageType)
    {
        ...
        {
            Long tmpChecksum = new Check(receipientOfOriginalMessage + text + timeStamp).Checksum();
            return tmpChecksum.equals(this.checkSum);
        }
       /* else if(messageType.equals(Message.REQUEST_GET_CLIENTS))
        {
 ...
 */
    ...
    private static void corruptOrDontSend(DatagramSocket socket, DatagramPacket packet, String msg) throws IOException 
    {
        ...
        if(rand.nextInt(3)==0)//generates a pseudorandom int between 0 and 9 incl. The odds of the value being 0 are 1 in 10, or 10%.
        {
            ...
            else //we corrupt
            {
                ...
                System.out.println(corruptedMessage);
                byte buf[] = new byte[1024];
    ...
    public boolean sameMessage(String sentAndReceivedFlagLine)
    {
        ...
        System.out.println(tmpSent + " vs " + this.sent);
        //System.out.println(this.sent);
        String tmpReceived = receiptLine[1].substring(9);
        System.out.println(tmpReceived + " vs " + this.received);
